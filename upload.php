...
/*check for the post data and Proceed*/
...
if ($_POST["name"]) {
	...
	$_SESSION['passwordhash'] =  $_POST["passwordhash"];
...
//Will move this file to the setup php
...
/*remoeve the delete part of the project*/
...
<head>
	...
	<meta name="generator" content="begc.in" />
	<title>Begc Registration Photo upload</title>
...
if(strlen($error)>0){
	echo "<font color=#cc3333>Error!</br>".$error."</font>";
}
...
?>
	<form name="data" action="registration.php" method="post">
		<input type="hidden" name="name" value="<?php echo $_SESSION['name'] ?>" />
		<input type="hidden" name="email" value="<?php echo $_SESSION['email'] ?>" />
		<input type="hidden" name="passwordhash" value="<?php echo $_SESSION['passwordhash'] ?>" />
		<input type="hidden" name="imagelocation" value="<?php echo $upload_path.$thumb_image_name.$_SESSION['user_file_ext'] ?>" />
		<input type="submit" name="uploadimage" value="Proceed">
	</form>

<?php

	echo $_SESSION['imagelocation'];
	...
	$_SESSION['user_file_ext']= "";
		...
		<div align="center">
			...
			<form name="thumbnail" action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
				...
				<?php 
					echo $upload_path.$large_image_name.$_SESSION['user_file_ext']; 
					$_SESSION['imagelocation'] = $upload_path.$large_image_name.$_SESSION['user_file_ext'];
...
<?php } ?>
</fieldset>  <!-- kontaktdaten class ends here -->
</div>  <!-- kontaktformular class ends here -->
</body>
</html>
