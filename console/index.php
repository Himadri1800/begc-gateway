...
<form action="listall.php" method="post" id ='myForm' name="myForm" >
 ...
 <table>
    <tr>
    	<td class="label"><label>Username: <span class="pflichtfeld">*</span></label></td>
      	<td class="field"><input type="text" name="name" maxlength="25" id="textfield" value="" size="20"</td>
      </tr>

     <tr>
    	<td class="label"><label>Password: <span class="pflichtfeld">*</span></label></td>
      	<td class="field"><input type="password" name="password" maxlength="25" id="textfield" value="" size="20"</td>
      </tr>
